#!/bin/sh
set -x
${CLANG_TIDY:-clang-tidy} --checks="clang-*,misc-*" \
	                      ...
	                      --extra-arg-before="-Isrc/third_party/rocketlib/include" \
	                      --extra-arg-before="-Isrc/third_party/closedrocket/embedded-coder/codegen/lib/GNC_codegen" \
	                      --extra-arg-before="-Isrc/third_party/cubemx_autogen/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc" \
	                      --extra-arg-before="-Isrc/third_party/cubemx_autogen/Middlewares/ST/STM32_USB_Device_Library/Core/Inc" \
	                      --extra-arg-before="-Isrc/third_party/printf" \
	                      --extra-arg-before="-include" \
	                      --extra-arg-before="src/application/health_checks/health_checks.h" \
