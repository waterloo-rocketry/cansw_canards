...
w_status_t adxl38x_read_device_data(adxl38x_dev_t *dev,
					uint8_t base_address,
					uint16_t size,
					uint8_t *read_data);

w_status_t adxl38x_write_device_data(adxl38x_dev_t *dev,
					 uint8_t base_address,
					 uint16_t size,
					 uint8_t *write_data);

w_status_t adxl38x_register_update_bits(adxl38x_dev_t *dev,
					uint8_t reg_addr,
					uint8_t mask,
					uint8_t update_val);
...
w_status_t adxl38x_set_self_test_registers(adxl38x_dev_t *dev,
					   bool st_mode,
					   bool st_force,
					   bool st_dir);
...
w_status_t adxl38x_get_sts_reg(adxl38x_dev_t *dev,
			       adxl38x_sts_reg_flags_t *status_flags);

w_status_t adxl38x_get_raw_xyz(adxl38x_dev_t *dev,
			       uint16_t *raw_x,
			       uint16_t *raw_y,
			       uint16_t *raw_z);
...
w_status_t adxl38x_get_raw_data(adxl38x_dev_t *dev,
...
w_status_t adxl38x_get_xyz_gees(adxl38x_dev_t *dev,
				enum adxl38x_ch_select channels,
			float *x,
			float *y,
			float *z);

w_status_t adxl38x_selftest(adxl38x_dev_t *dev,
			    enum adxl38x_op_mode op_mode,
			    bool *st_x,
			    bool *st_y,
			    bool *st_z);

w_status_t adxl38x_accel_set_FIFO(adxl38x_dev_t *dev,
...
w_status_t adxl38x_data_raw_to_gees(adxl38x_dev_t *dev,
