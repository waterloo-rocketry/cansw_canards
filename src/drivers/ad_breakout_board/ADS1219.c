...
static w_status_t ads1219_send_cmd(ads1219_handle_t *p_handle, uint8_t cmd) {
	...
	// functions
	return i2c_write_reg(p_handle->bus, p_handle->i2c_addr, cmd, &dummy_data, 1);
}
 ...
 * @return status of function
 */
w_status_t ads1219_set_vref(ads1219_handle_t *p_handle, uint8_t vref, float aref_n, float aref_p) {
	uint8_t value;
 ...
 * @return status of function
 */
w_status_t ads1219_millivolts(ads1219_handle_t *p_handle, const int32_t adc_count, float *mv) {
	float span = p_handle->aref_p - p_handle->aref_n;
 ...
 * @return status of function
 */
w_status_t ads1219_get_millivolts(ads1219_handle_t *p_handle, float *data) {
	uint32_t value;
