...
static gpio_pin_data_t gpio_map[GPIO_PIN_COUNT] = {
	...
	[GPIO_PIN_ADXRS649_ST1] = {.port = ADXRS_ST1_GPIO_Port, .pin = ADXRS_ST1_Pin, .access_mutex = NULL},
	[GPIO_PIN_ADXRS649_ST2] = {.port = ADXRS_ST2_GPIO_Port, .pin = ADXRS_ST2_Pin, .access_mutex = NULL},
};
