...
volatile uint64_t write_dma_sum_count = 0;
volatile uint64_t read_dma_sum_count = 0;
volatile uint64_t error_dma_count = 0;
...
static uint8_t read_buffer[CACHE_SIZE] __attribute__((section(".sdmmc2_ram"))) = {0};
static uint8_t prog_buffer[CACHE_SIZE] __attribute__((section(".sdmmc2_ram"))) = {0};
...
const struct lfs_config cfg = {
	...
	.compact_thresh = 0, // potentially turn off if too much performance penailty
