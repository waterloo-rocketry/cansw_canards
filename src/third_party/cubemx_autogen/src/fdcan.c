...
void MX_FDCAN3_Init(void)
{
  ...
  hfdcan3.Init.MessageRAMOffset = 100;
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  /* USER CODE END FDCAN1_MspInit 0 */
    ...
    PD1     ------> FDCAN1_TX
    */
    GPIO_InitStruct.Pin = S_CAN_RX_Pin|S_CAN_TX_Pin;
  ...
  /* USER CODE END FDCAN2_MspInit 0 */
    ...
    PB13     ------> FDCAN2_TX
    */
    GPIO_InitStruct.Pin = M_CAN_RX_Pin|M_CAN_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END FDCAN3_MspInit 0 */
    ...
    PD13     ------> FDCAN3_TX
    */
    GPIO_InitStruct.Pin = R_CAN_RX_Pin|R_CAN_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* fdcanHandle)
{
  ...
  /* USER CODE END FDCAN1_MspDeInit 0 */
    ...
    PD1     ------> FDCAN1_TX
    */
    HAL_GPIO_DeInit(GPIOD, S_CAN_RX_Pin|S_CAN_TX_Pin);
  ...
  /* USER CODE END FDCAN2_MspDeInit 0 */
    ...
    PB13     ------> FDCAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, M_CAN_RX_Pin|M_CAN_TX_Pin);
