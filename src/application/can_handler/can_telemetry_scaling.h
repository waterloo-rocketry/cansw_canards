...
static const can_scale_data_t can_scale_factor[SCALE_COUNT] = {
	...
	[SCALE_BOARD_ACCEL] = {.type = TYPE_INT16, .scale = 100},
	[SCALE_BOARD_GYRO] = {.type = TYPE_INT16, .scale = 100},
	[SCALE_BOARD_PRESSURE] = {.type = TYPE_UINT24, .scale = 1},
	[SCALE_BOARD_MAG] = {.type = TYPE_INT16, .scale = 1000},

	[SCALE_ADXRS649_GYROSCOPE] = {.type = TYPE_INT32, .scale = 100},
	[SCALE_ADXL380_ACCEL] = {.type = TYPE_INT16, .scale = 100},

	[SCALE_SERVO_ANGLE] = {.type = TYPE_INT32, .scale = 1000},
