...
typedef enum {
	...
	MODULE_ERR_GPIO_FAIL = 3,
	MODULE_POWER_HANDLER_FAULT_BAT1_FAULT = 4,
	MODULE_POWER_HANDLER_FAULT_BAT2_FAULT = 5,
	MODULE_POWER_HANDLER_FAULT_5V_EXT_OUTPUT = 6,
	MODULE_POWER_HANDLER_LOW_POWER_MODE_WITH_EXT_5V_ON = 7,
	MODULE_ERR_MAX = 31
} module_error_code_t;
