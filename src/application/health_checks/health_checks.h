...
typedef enum {
	...
	MODULE_TIMER_HANDLE_INVALID = 3,
	MODULE_POWER_HANDLER_FAULT_BAT1_VOLT = 4,
	MODULE_POWER_HANDLER_FAULT_BAT2_VOLT = 5,
	MODULE_POWER_HANDLER_FAULT_RKT_VOLT = 6,
	MODULE_POWER_HANDLER_FAULT_CHG_VOLT = 7,
	MODULE_POWER_HANDLER_FAULT_5V_CURR = 8,
	MODULE_POWER_HANDLER_FAULT_5V_EXT_OUTPUT = 9,
	MODULE_POWER_HANDLER_FAULT_3V3_CURR = 10,
	MODULE_POWER_HANDLER_FAULT_BAT1_CURR = 11,
	MODULE_POWER_HANDLER_FAULT_BAT2_CURR = 12,
	MODULE_ERR_MAX = 31
} module_error_code_t;
