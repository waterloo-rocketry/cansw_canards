...
typedef enum {
	...
	MODULE_ERR_POWER_HANDLER_BAT1_UNDER_VOLT,
	MODULE_ERR_POWER_HANDLER_BAT1_OVER_VOLT,
	MODULE_ERR_POWER_HANDLER_BAT2_UNDER_VOLT,
	MODULE_ERR_POWER_HANDLER_BAT2_OVER_VOLT,
	MODULE_ERR_POWER_HANDLER_RKT_UNDER_VOLT,
	MODULE_ERR_POWER_HANDLER_RKT_OVER_VOLT,
	MODULE_ERR_POWER_HANDLER_CHG_UNDER_VOLT,
	MODULE_ERR_POWER_HANDLER_CHG_OVER_VOLT,
	MODULE_ERR_POWER_HANDLER_5V_EXT_EFUSE_FAULT,
	MODULE_ERR_POWER_HANDLER_5V_OVER_CURR,
	MODULE_ERR_POWER_HANDLER_3V3_OVER_CURR,
	MODULE_ERR_POWER_HANDLER_BAT1_OVER_CURR,
	MODULE_ERR_POWER_HANDLER_BAT2_OVER_CURR
} module_error_code_t;
