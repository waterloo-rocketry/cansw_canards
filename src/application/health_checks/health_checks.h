...
typedef enum {
	MODULE_CAN_HANDLER_DROPPED_RX = 1,
	MODULE_CAN_HANDLER_DROPPED_TX = 2,
	MODULE_ERR_AK45_FAILED_CALIBRATION = 3,
	MODULE_ERR_AK45_NOT_CALIBRATED = 4,
	MODULE_ERR_CRITICAL = 5,
	MODULE_ERR_FLIGHT_PHASE_ERROR_STATE = 6,
	MODULE_ERR_FLIGHT_PHASE_EVENT_SEND_FAILED = 7,
	MODULE_ERR_FLIGHT_PHASE_INVALID_EVENT = 8,
	MODULE_ERR_GPIO_FAIL = 9,
	MODULE_ERR_INVALID_PARAM = 10,
	MODULE_ERR_NOT_INIT = 11,
	MODULE_ERR_NOT_RUN = 12,
	MODULE_ERR_NULL_CTX = 13,
	MODULE_ERR_OVERFLOW = 14,
	MODULE_ERR_PERIPHERAL_COMM_FAIL = 15,
	MODULE_ERR_TIMEOUT = 16,
	MODULE_ERR_TX_FAILURE = 17,
	MODULE_ERR_UNKNOWN_STATE = 18,
	MODULE_MS5611_BARO_CRC_FAILED = 19,
	MODULE_POWER_HANDLER_FAULT_BAT1_FAULT = 20,
	MODULE_POWER_HANDLER_FAULT_BAT2_FAULT = 21,
	MODULE_POWER_HANDLER_LOW_POWER_MODE_WITH_EXT_5V_ON = 22,
	MODULE_SENSOR_HANDLER_ERR_AD_ACCEL = 23,
	MODULE_SENSOR_HANDLER_ERR_AD_GYRO = 24,
	MODULE_SENSOR_HANDLER_ERR_BOARD_BARO = 25,
	MODULE_SENSOR_HANDLER_ERR_BOARD_IMU = 26,
	MODULE_SENSOR_HANDLER_ERR_BOARD_MAG = 27,
	MODULE_SENSOR_HANDLER_ERR_MOTOR = 28,
	MODULE_SENSOR_HANDLER_ERR_MTI = 29,
	MODULE_TELEMETRY_FUNC_REGISTER_FAILED = 30,
	MODULE_TELEMETRY_TX_OVERDUE = 31,
	MODULE_TIMER_HANDLE_INVALID = 32,
	MODULE_ERR_MAX = 31
} module_error_code_t;
