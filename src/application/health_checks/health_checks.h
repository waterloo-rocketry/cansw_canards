...
typedef enum {
	...
	MODULE_ERR_I2C_FAIL,
	MODULE_ERR_NOT_INIT,
	MODULE_POWER_HANDLER_FAULT_BAT1_VOLT,
	MODULE_POWER_HANDLER_FAULT_BAT2_VOLT,
	MODULE_POWER_HANDLER_FAULT_RKT_VOLT,
	MODULE_POWER_HANDLER_FAULT_CHG_VOLT,
	MODULE_POWER_HANDLER_FAULT_5V_CURR,
	MODULE_POWER_HANDLER_FAULT_5V_EXT_OUTPUT,
	MODULE_POWER_HANDLER_FAULT_3V3_CURR,
	MODULE_POWER_HANDLER_FAULT_BAT1_CURR,
	MODULE_POWER_HANDLER_FAULT_BAT2_CURR,
	MODULE_ERR_AK45_FAILED_CALIBRATION
} module_error_code_t;
