...
typedef enum {
	...
	MODULE_SENSOR_HANDLER_ERR_BOARD_IMU = 12,
	MODULE_SENSOR_HANDLER_ERR_BOARD_MAG = 13,
	MODULE_SENSOR_HANDLER_ERR_BOARD_BARO = 14,
	MODULE_SENSOR_HANDLER_ERR_AD_ACCEL = 15,
	MODULE_SENSOR_HANDLER_ERR_AD_GYRO = 16,
	MODULE_SENSOR_HANDLER_ERR_MTI = 17,
	MODULE_SENSOR_HANDLER_ERR_MOTOR = 18,
	MODULE_ERR_MAX = 31
} module_error_code_t;
