...
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Mem_Read_IT, I2C_HandleTypeDef *, uint16_t,
						uint16_t, uint16_t, uint8_t *, uint16_t);
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Mem_Write_IT, I2C_HandleTypeDef *, uint16_t,
						uint16_t, uint16_t, uint8_t *, uint16_t);
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Master_Transmit_IT, I2C_HandleTypeDef *,
						uint16_t, uint8_t *, uint16_t);
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_Mem_Read_DMA, I2C_HandleTypeDef *, uint16_t,
						uint16_t, uint16_t, uint8_t *, uint16_t);
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_RegisterCallback, I2C_HandleTypeDef *,
						HAL_I2C_CallbackIDTypeDef, pI2C_CallbackTypeDef);
DECLARE_FAKE_VALUE_FUNC(HAL_StatusTypeDef, HAL_I2C_UnRegisterCallback, I2C_HandleTypeDef *,
						HAL_I2C_CallbackIDTypeDef);
